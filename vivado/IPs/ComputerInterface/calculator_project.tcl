...
#
# calculator_project.tcl: Tcl script for re-creating project 'ComputerInterface'
#
# Generated by Vivado on Tue May 10 03:26:44 EDT 2016
...
#
# 1. This project restoration tcl script (calculator_project.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/josem/Documents/Academics/Spring2016/CPEG324TA/Labs/Lab2_Template_2/ComputerInterface/ComputerInterface.srcs/sources_1/new/UART.vhd"
#    "/home/josem/Documents/Academics/Spring2016/CPEG324TA/Labs/Lab2_Template_2/ComputerInterface/ComputerInterface.srcs/sources_1/new/CommandsProcessingUnit.vhd"
#    "/home/josem/Documents/Academics/Spring2016/CPEG324TA/Labs/Lab2_Template_2/ComputerInterface/ComputerInterface.srcs/sources_1/new/FIFO_Buffers.vhd"
#    "/home/josem/Documents/Academics/Spring2016/CPEG324TA/Labs/Lab2_Template_2/ComputerInterface/ComputerInterface.srcs/sources_1/new/ComputerInterface.vhd"
#    "/home/josem/Documents/Academics/Spring2016/CPEG324TA/Labs/Lab2_Template_2/ComputerInterface/ComputerInterface.srcs/component.xml"
#    "/home/josem/Documents/Academics/Spring2016/CPEG324TA/Labs/Lab2_Template_2/ComputerInterface/ComputerInterface.srcs/sim_1/new/CommandsProcessingUnit_tb.vhd"
#
...
set script_file "calculator_project.tcl"
...
# Create project
create_project ComputerInterface ./ComputerInterface

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects ComputerInterface]
set_property "board_part" "" $obj
set_property "compxlib.activehdl_compiled_library_dir" "$proj_dir/ComputerInterface.cache/compile_simlib/activehdl" $obj
set_property "compxlib.funcsim" "1" $obj
set_property "compxlib.ies_compiled_library_dir" "$proj_dir/ComputerInterface.cache/compile_simlib/ies" $obj
set_property "compxlib.modelsim_compiled_library_dir" "$proj_dir/ComputerInterface.cache/compile_simlib/modelsim" $obj
set_property "compxlib.overwrite_libs" "0" $obj
set_property "compxlib.questa_compiled_library_dir" "$proj_dir/ComputerInterface.cache/compile_simlib/questa" $obj
set_property "compxlib.riviera_compiled_library_dir" "$proj_dir/ComputerInterface.cache/compile_simlib/riviera" $obj
set_property "compxlib.timesim" "1" $obj
set_property "compxlib.vcs_compiled_library_dir" "$proj_dir/ComputerInterface.cache/compile_simlib/vcs" $obj
...
set_property "part" "xc7z010clg400-3" $obj
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/ComputerInterface.srcs"]" $obj
...
set obj [get_filesets sources_1]
set files [list \
 "[file normalize "$origin_dir/ComputerInterface.srcs/sources_1/new/UART.vhd"]"\
 "[file normalize "$origin_dir/ComputerInterface.srcs/sources_1/new/CommandsProcessingUnit.vhd"]"\
 "[file normalize "$origin_dir/ComputerInterface.srcs/sources_1/new/FIFO_Buffers.vhd"]"\
 "[file normalize "$origin_dir/ComputerInterface.srcs/sources_1/new/ComputerInterface.vhd"]"\
 "[file normalize "$origin_dir/ComputerInterface.srcs/component.xml"]"\
]
...
set file "new/CommandsProcessingUnit.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "new/ComputerInterface.vhd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property "file_type" "VHDL" $file_obj
set_property "is_enabled" "1" $file_obj
set_property "is_global_include" "0" $file_obj
...
set file "ComputerInterface.srcs/component.xml"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property "top" "ComputerInterface" $obj
...
set files [list \
 "[file normalize "$origin_dir/ComputerInterface.srcs/sim_1/new/CommandsProcessingUnit_tb.vhd"]"\
]
add_files -norecurse -fileset $obj $files
...
set file "new/CommandsProcessingUnit_tb.vhd"
...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part xc7z010clg400-3 -flow {Vivado Synthesis 2015} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
  create_run -name impl_1 -part xc7z010clg400-3 -flow {Vivado Implementation 2015} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
} else {
...
puts "INFO: Project created:ComputerInterface"
