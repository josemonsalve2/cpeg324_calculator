...
proc update_MODELPARAM_VALUE.FIFO_WIDTH { MODELPARAM_VALUE.FIFO_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "FIFO_WIDTH". Setting updated value from the model parameter.
set_property value 8 ${MODELPARAM_VALUE.FIFO_WIDTH}
}
...
proc update_MODELPARAM_VALUE.clock_frequency { MODELPARAM_VALUE.clock_frequency } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "clock_frequency". Setting updated value from the model parameter.
set_property value 125000000 ${MODELPARAM_VALUE.clock_frequency}
}
